...
//  1. GDRIVE_REFRESH_TOKEN in the environment (CI, automation).
...
const ServiceName = "google-drive-mcp"

// EnvVar is the environment override.
const EnvVar = "GDRIVE_REFRESH_TOKEN"
...
var ErrNotFound = errors.New("credentials: no refresh token found; run `google-drive-mcp login`")
