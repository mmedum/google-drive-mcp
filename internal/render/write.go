...
type WriteJSON struct {
	...
	Action string `json:"action" jsonschema:"what happened: created, uploaded, updated, moved, copied, trashed, restored, or unchanged when the call found nothing to do"`
...
func Actions() []string {
	all := []Action{ActionCreated, ActionUploaded, ActionUpdated, ActionMoved,
		ActionCopied, ActionTrashed, ActionRestored, ActionUnchanged}
