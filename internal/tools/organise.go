...
type CopyFileInput struct {
	...
	CopyComments        bool   `json:"copy_comments,omitempty" jsonschema:"ask Drive to bring the comment threads along. It does not always, and its answer says nothing either way: a live run copied a CSV carrying an open thread and the copy had none, minutes later still none. list_comments on the copy is what tells you. Off by default: the threads are other people's words, and the copy may end up somewhere they cannot see."`
