...
// -ldflags "-X github.com/mmedum/google-drive-mcp/internal/version.Version=v1.2.3".
package version
...
func Info() string {
	return fmt.Sprintf("google-drive-mcp %s (%s %s/%s)", String(), runtime.Version(), runtime.GOOS, runtime.GOARCH)
}
