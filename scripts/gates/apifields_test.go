...
func fieldsFixture() fieldsSnapshot {
	return fieldsSnapshot{Fetched: "2026-09-12", APIs: []fieldsAPI{
		...
		{API: "driveactivity", Schemas: []fieldsSchema{
...
func TestFieldsProblems(t *testing.T) {
	...
	ownerRow := fieldsRow{API: "drive", Schema: "Membership", Property: "*", Verdict: "owner", Reason: "Drive's", line: 1}
	unrelatedRow := fieldsRow{API: "drive", Schema: "Section", Property: "*", Verdict: "unrelated", Reason: "a sidebar section", line: 2}
	...
	cases := []struct {
		...
		},
		{
			...
			rows: []fieldsRow{ownerRow, {API: "drive", Schema: "Section", Property: "header",
		...
		},
		{
			...
			rows: []fieldsRow{unrelatedRow, {API: "drive", Schema: "Message", Property: "*",
				Verdict: "owner", Reason: "mine", line: 3}},
			want: "claims ownership of a schema name only drive publishes",
		},
		{
			name: "a row for a schema Google has withdrawn",
			rows: both(fieldsRow{API: "drive", Schema: "Telepathy", Property: "x",
				Verdict: "out", Reason: "invented", line: 3}),
			want: "is not a published schema any more",
		},
		{
			name: "a verdict with no reason",
			rows: both(fieldsRow{API: "drive", Schema: "Message", Property: "text",
				Verdict: "out", line: 3}),
		...
		},
		{
			...
			rows: both(fieldsRow{API: "drive", Schema: "Membership", Property: "*",
				Verdict: "owner", Reason: "Drive's", line: 9}),
			want: "already has a verdict on line 1",
		},
		{
			name: "an alias naming a struct that does not exist",
			rows: both(fieldsRow{API: "driveactivity", Schema: "Membership", Property: "*",
...
func TestFieldsProblemsCatchesAFieldGoogleAdds(t *testing.T) {
	...
	rows := []fieldsRow{
		{API: "drive", Schema: "Membership", Property: "*", Verdict: "owner", Reason: "Drive's", line: 1},
...
// a floor of 20 against a real 34 could not notice.
